...
func (x *AccessLogConfig) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *AccessLogConfig) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AccessLogConfig) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
var file_access_log_config_v1_access_log_config_proto_rawDesc = string([]byte{
	...
	0x67, 0x2e, 0x76, 0x31, 0x22, 0x55, 0x0a, 0x0f, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f,
	0x67, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x01,
	...
	0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x42, 0xf8, 0x01, 0x0a, 0x18,
...
var file_access_log_config_v1_access_log_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_access_log_config_v1_access_log_config_proto_goTypes = []any{
	(*AccessLogConfig)(nil), // 0: access_log_config.v1.AccessLogConfig
}
