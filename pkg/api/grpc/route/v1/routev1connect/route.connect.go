...
const (
	// RouteStoreServiceName is the fully-qualified name of the RouteStoreService service.
	RouteStoreServiceName = "route.v1.RouteStoreService"
)
...
func NewRouteStoreServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) RouteStoreServiceClient {
